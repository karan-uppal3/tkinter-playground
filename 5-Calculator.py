...
button_minus = Button(root,text="-",padx=44,pady =20,command=button_minus)
button_mult = Button(root,text="*",padx=44,pady =20,command=button_mult)
button_div = Button(root,text="/",padx=44,pady =20,command=button_div)
